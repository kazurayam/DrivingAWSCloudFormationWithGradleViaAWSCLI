...
1. I want to use *https://gradle.org/[Gradle] Build Tool* to achieve
...
2. I want to use Gradle to do compiling, testing and archiving my Java applications as usual.
3. I want to automate provisioning a https://aws.amazon.com/s3/[AWS S3] Bucket where I locate the jar file containing
my Lambda functions.
4. I want to automate uploading the jar file up to the designated S3 Bucket every after I modify the application source and rebuild it.
